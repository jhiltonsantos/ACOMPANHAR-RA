...
public class DestinationDestino1Objects2Nivel3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa1Objects2Nivel3 draggableObject = other.GetComponent<DraggablePecaCaixa1Objects2Nivel3>();
