...
public class ARPlacementAndPlaneDetectionObjects2Nivel3 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerObjects2Nivel3 m_ARPlacementManagerNivel3;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManagerNivel3 = m_ARSessionOrigin.GetComponent<ARPlacementManagerObjects2Nivel3>();
    }
    ...
    public void DisableARPlacementAndPlaneDetection()
    {
        ...
        m_ARPlacementManagerNivel3.enabled = false;
    ...
    public void EnableARPlacementAndPlaneDetection()
    {
        ...
        m_ARPlacementManagerNivel3.enabled = true;
