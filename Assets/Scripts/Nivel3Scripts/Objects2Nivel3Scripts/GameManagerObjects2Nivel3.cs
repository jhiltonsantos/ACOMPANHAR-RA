...
public class GameManagerObjects2Nivel3 : MonoBehaviour
{
    ...
    public ARPlacementAndPlaneDetectionObjects2Nivel3 ARPlacementAndPlaneDetectionObjects2Nivel3;
    ...
    private int CountObjects()
    {
        ...
        foreach (string tag in tagsObjectsHaveMove)
        {
            ...
            {
                // Verifique se o objeto implementa a interface IDraggableObjects2Nivel3
                IDraggableObjects2Nivel3 draggableObject = obj.GetComponent<IDraggableObjects2Nivel3>();
    ...
    public void ResetLevel()
    {
        ...
        // Reset AR Planes
        ResetARPlanes();
        ARPlacementAndPlaneDetectionObjects2Nivel3.SetAllPlanesActiveOrDeactive(false);
    ...
    public void ShowMessage(string message, string buttonText)
    {
        ...
        ARPlacementAndPlaneDetectionObjects2Nivel3.SetButtonsDisable();
    }
    #endregion
}
