...
public class DestinationDestino2Objects2Nivel3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa2Objects2Nivel3 draggableObject = other.GetComponent<DraggablePecaCaixa2Objects2Nivel3>();
