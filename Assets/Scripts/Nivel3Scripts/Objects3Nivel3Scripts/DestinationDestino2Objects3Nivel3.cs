...
public class DestinationDestino2Objects3Nivel3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa2Objects3Nivel3 draggableObject = other.GetComponent<DraggablePecaCaixa2Objects3Nivel3>();
