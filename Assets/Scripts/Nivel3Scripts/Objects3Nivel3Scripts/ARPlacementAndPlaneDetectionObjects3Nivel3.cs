...
public class ARPlacementAndPlaneDetectionObjects3Nivel3 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerObject3Nivel3 m_ARPlacementManager;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManager = m_ARSessionOrigin.GetComponent<ARPlacementManagerObject3Nivel3>();
    }
