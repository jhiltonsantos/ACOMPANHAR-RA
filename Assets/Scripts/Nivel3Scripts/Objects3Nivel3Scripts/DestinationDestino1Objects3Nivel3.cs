...
public class DestinationDestino1Objects3Nivel3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa1Objects3Nivel3 draggableObject = other.GetComponent<DraggablePecaCaixa1Objects3Nivel3>();
