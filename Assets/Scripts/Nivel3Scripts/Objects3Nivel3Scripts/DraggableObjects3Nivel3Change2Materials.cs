...
public class DraggableObjects3Nivel3Change2Materials : MonoBehaviour, IDraggableObjects3Nivel3
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationObjects3Nivel3Change2Materials destinoScript;
    ...
    void Start()
    {
        ...
        destinoScript = GetComponentInParent<DestinationObjects3Nivel3Change2Materials>();
    }
