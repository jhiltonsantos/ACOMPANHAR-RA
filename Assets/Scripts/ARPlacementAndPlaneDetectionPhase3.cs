...
public class ARPlacementAndPlaneDetectionPhase3 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerPhase3 m_ARPlacementManager;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManager = m_ARSessionOrigin.GetComponent<ARPlacementManagerPhase3>();
    }
