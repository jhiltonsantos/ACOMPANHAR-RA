...
public class DraggableObjectPhase3 : MonoBehaviour
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationBoxPhase3Script destinationBoxScript;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        destinationBoxScript = GetComponentInParent<DestinationBoxPhase3Script>();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            GameManagerPhase3 gameManager = FindObjectOfType<GameManagerPhase3>();
            if (gameManager != null)
            {
