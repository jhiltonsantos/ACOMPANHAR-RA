...
public class DraggableObjectPhase2Nivel2 : MonoBehaviour
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationBoxPhase2ScriptNivel2 DestinationBoxPhase1ScriptNivel2;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        DestinationBoxPhase1ScriptNivel2 = GetComponentInParent<DestinationBoxPhase2ScriptNivel2>();
    }
