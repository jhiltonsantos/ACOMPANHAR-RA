...
public class DestinationDestino1Objects3Nivel2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa1Objects3Nivel2 draggableObject = other.GetComponent<DraggablePecaCaixa1Objects3Nivel2>();
