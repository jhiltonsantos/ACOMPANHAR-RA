...
public class DestinationDestino3Objects3Nivel2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa3Objects3Nivel2 draggableObject = other.GetComponent<DraggablePecaCaixa3Objects3Nivel2>();
