...
public class DestinationBoxDestinoBrancoPhase2Nivel2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggableObjectPecaCaixa1Phase2Nivel2 draggableObject = other.GetComponent<DraggableObjectPecaCaixa1Phase2Nivel2>();
