...
public class DraggableObjectPhase3Nivel2 : MonoBehaviour
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationBoxPhase3ScriptNivel2 DestinationBoxPhase1ScriptNivel2;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        DestinationBoxPhase1ScriptNivel2 = GetComponentInParent<DestinationBoxPhase3ScriptNivel2>();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            GameManagerPhase3Nivel2 gameManager = FindObjectOfType<GameManagerPhase3Nivel2>();
            if (gameManager != null)
            {
