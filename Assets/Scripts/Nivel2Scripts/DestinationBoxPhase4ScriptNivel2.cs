...
public class DestinationBoxPhase4ScriptNivel2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggableObjectPhase4Nivel2 draggableObject1 = other.GetComponent<DraggableObjectPhase4Nivel2>();
        ...
        {
            DraggableObjectPhase4Nivel2 draggableObject2 = other.GetComponent<DraggableObjectPhase4Nivel2>();
        ...
        {
            DraggableObjectPhase4Nivel2 draggableObject3 = other.GetComponent<DraggableObjectPhase4Nivel2>();
