...
public class GameManagerPhase4Nivel2 : MonoBehaviour
{
    ...
    public List<DestinationBoxPhase4ScriptNivel2> destinationBoxes = new List<DestinationBoxPhase4ScriptNivel2>();
    public ARPlaneManager arPlaneManager;
    public ARPlacementAndPlaneDetectionPhase4Nivel2 ARPlacementAndPlaneDetectionPhase1Nivel2;
    ...
    {
        int count = 0;
        DraggableObjectPhase4Nivel2[] draggableObjects = FindObjectsOfType<DraggableObjectPhase4Nivel2>();
        foreach (DraggableObjectPhase4Nivel2 draggableObject in draggableObjects)
        {
        ...
        foreach (DestinationBoxPhase4ScriptNivel2 destination in destinationBoxes)
        {
            count++;
        }
        return count;
    ...
    public void ResetLevel()
    {
        ...
        foreach (DestinationBoxPhase4ScriptNivel2 destinationBox in destinationBoxes)
        {
