...
public class DestinationBoxPhase3ScriptNivel2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggableObjectPhase3Nivel2 draggableObject1 = other.GetComponent<DraggableObjectPhase3Nivel2>();
        ...
        {
            DraggableObjectPhase3Nivel2 draggableObject2 = other.GetComponent<DraggableObjectPhase3Nivel2>();
