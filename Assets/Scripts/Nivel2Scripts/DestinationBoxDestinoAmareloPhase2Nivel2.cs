...
public class DestinationBoxDestinoAmareloPhase2Nivel2 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggableObjectPecaCaixa2Phase2Nivel2 draggableObject = other.GetComponent<DraggableObjectPecaCaixa2Phase2Nivel2>();
