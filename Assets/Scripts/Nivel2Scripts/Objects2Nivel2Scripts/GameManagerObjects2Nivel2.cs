...
public class GameManagerObjects2Nivel2 : MonoBehaviour
{
    ...
    public ARPlacementAndPlaneDetectionObjects2Nivel2 ARPlacementAndPlaneDetectionObjects2Nivel2;
    ...
    private int CountObjects()
    {
        ...
        foreach (string tag in tagsObjectsHaveMove)
        {
            ...
            {
                // Verifique se o objeto implementa a interface IDraggableObjects2Nivel2
                IDraggableObjects2Nivel2 draggableObject = obj.GetComponent<IDraggableObjects2Nivel2>();
    ...
    public void ResetLevel()
    {
        ...
        // Reset AR Planes
        ResetARPlanes();
        ARPlacementAndPlaneDetectionObjects2Nivel2.SetAllPlanesActiveOrDeactive(false);
    ...
    public void ShowMessage(string message, string buttonText)
    {
        ...
        ARPlacementAndPlaneDetectionObjects2Nivel2.SetButtonsDisable();
    }
    #endregion
}
