...
public class DraggablePecaCaixa2Objects2Nivel2 : MonoBehaviour, IDraggableObjects2Nivel2
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationDestino2Objects2Nivel2 destinoScript;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        destinoScript = GetComponentInParent<DestinationDestino2Objects2Nivel2>();
    }
