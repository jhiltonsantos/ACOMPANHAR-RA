...
public class DraggableObjects2Nivel2 : MonoBehaviour, IDraggableObjects2Nivel2
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationObjects2Nivel2 destinoScript;
    ...
    void Start()
    {
        ...
        destinoScript = GetComponentInParent<DestinationObjects2Nivel2>();
    }
