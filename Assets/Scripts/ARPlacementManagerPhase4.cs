...
public class ARPlacementManagerPhase4 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        DestinationBoxPhase4Script[] destinationBoxScripts = FindObjectsOfType<DestinationBoxPhase4Script>();
        foreach (DestinationBoxPhase4Script destinationBoxScript in destinationBoxScripts)
        {
