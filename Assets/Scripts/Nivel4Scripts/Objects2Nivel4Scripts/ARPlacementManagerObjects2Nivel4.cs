...
public class ARPlacementManagerObjects2Nivel4 : MonoBehaviour
{
    ...
    private GameManagerObjects2Nivel4 gameManager;

    private void Awake()
    {
        m_ARRaycastManager = GetComponent<ARRaycastManager>();
        gameManager = FindObjectOfType<GameManagerObjects2Nivel4>();
    }
