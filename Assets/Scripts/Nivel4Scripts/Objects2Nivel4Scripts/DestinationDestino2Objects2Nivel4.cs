...
public class DestinationDestino2Objects2Nivel4 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa2Objects2Nivel4 draggableObject = other.GetComponent<DraggablePecaCaixa2Objects2Nivel4>();
