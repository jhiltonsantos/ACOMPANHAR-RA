...
public class DestinationDestino1Objects2Nivel4 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa1Objects2Nivel4 draggableObject = other.GetComponent<DraggablePecaCaixa1Objects2Nivel4>();
