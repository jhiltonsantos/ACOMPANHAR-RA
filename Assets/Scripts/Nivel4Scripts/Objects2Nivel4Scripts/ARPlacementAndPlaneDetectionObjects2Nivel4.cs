...
public class ARPlacementAndPlaneDetectionObjects2Nivel4 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerObjects2Nivel4 m_ARPlacementManagerNivel4;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManagerNivel4 = m_ARSessionOrigin.GetComponent<ARPlacementManagerObjects2Nivel4>();
    }
    ...
    public void DisableARPlacementAndPlaneDetection()
    {
        ...
        m_ARPlacementManagerNivel4.enabled = false;
    ...
    public void EnableARPlacementAndPlaneDetection()
    {
        ...
        m_ARPlacementManagerNivel4.enabled = true;
