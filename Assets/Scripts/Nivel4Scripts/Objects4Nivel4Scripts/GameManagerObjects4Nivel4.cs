...
public class GameManagerObjects4Nivel4 : MonoBehaviour
{
    ...
    private int CountObjects()
    {
        ...
        foreach (string tag in tagsObjectsHaveMove)
        {
            ...
            {
                // Verifique se o objeto implementa a interface IDraggableObjects4Nivel4
                IDraggableObjects4Nivel4 draggableObject = obj.GetComponent<IDraggableObjects4Nivel4>();
