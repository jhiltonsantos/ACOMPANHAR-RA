...
public class ARPlacementAndPlaneDetectionObjects4Nivel4 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerObject4Nivel4 m_ARPlacementManager;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManager = m_ARSessionOrigin.GetComponent<ARPlacementManagerObject4Nivel4>();
    }
