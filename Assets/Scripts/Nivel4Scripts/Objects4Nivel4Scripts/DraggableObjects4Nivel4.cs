...
public class DraggableObjects4Nivel4 : MonoBehaviour, IDraggableObjects4Nivel4
{
    ...
    private DestinationObjects4Nivel4 destinoScript;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        destinoScript = GetComponentInParent<DestinationObjects4Nivel4>();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            GameManagerObjects4Nivel4 gameManager = FindObjectOfType<GameManagerObjects4Nivel4>();
            if (gameManager != null)
            {
