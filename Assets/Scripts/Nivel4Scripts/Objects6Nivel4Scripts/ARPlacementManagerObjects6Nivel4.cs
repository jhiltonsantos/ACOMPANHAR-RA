...
public class ARPlacementManagerObjects6Nivel4 : MonoBehaviour
{
    ...
    public GameObject box6GameObject;
    ...
    public GameObject destiny6GameObject;
    ...
    public Vector3 destination6Offset;
    public GameObject objectExampleGameObject;
    public Vector3 objectExampleOffset;
    private GameManagerObjects6Nivel4 gameManager;

    private void Awake()
    {
        m_ARRaycastManager = GetComponent<ARRaycastManager>();
        gameManager = FindObjectOfType<GameManagerObjects6Nivel4>();
    }
    ...
    void Update()
    {
        ...
        if (m_ARRaycastManager.Raycast(ray, raycastHits, TrackableType.PlaneWithinPolygon))
        {
            ...
            box6GameObject.transform.position = positionToBePlaced + boxOffset6;
            ...
            destiny6GameObject.transform.position = positionToBePlaced + destination6Offset;

            objectExampleGameObject.transform.position = positionToBePlaced + objectExampleOffset;
        }
    }
}
