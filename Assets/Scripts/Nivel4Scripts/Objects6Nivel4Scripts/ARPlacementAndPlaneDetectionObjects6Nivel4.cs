...
public class ARPlacementAndPlaneDetectionObjects6Nivel4 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerObjects6Nivel4 m_ARPlacementManager;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManager = m_ARSessionOrigin.GetComponent<ARPlacementManagerObjects6Nivel4>();
    }
