...
public class GameManagerObjects6Nivel4 : MonoBehaviour
{
    ...
    public ARPlacementAndPlaneDetectionObjects6Nivel4 ARPlacementAndPlaneDetection;
    ...
    private int CountObjects()
    {
        ...
        foreach (string tag in tagsObjectsHaveMove)
        {
            ...
            {
                IDraggableObjects6Nivel4 draggableObject = obj.GetComponent<IDraggableObjects6Nivel4>();
