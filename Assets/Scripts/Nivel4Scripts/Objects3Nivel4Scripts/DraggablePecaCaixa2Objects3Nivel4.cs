...
public class DraggablePecaCaixa2Objects3Nivel4 : MonoBehaviour, IDraggableObjects3Nivel4
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationDestino2Objects3Nivel4 destinoScript;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        destinoScript = GetComponentInParent<DestinationDestino2Objects3Nivel4>();
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            GameManagerObjects3Nivel4 gameManager = FindObjectOfType<GameManagerObjects3Nivel4>();
            if (gameManager != null)
            {
