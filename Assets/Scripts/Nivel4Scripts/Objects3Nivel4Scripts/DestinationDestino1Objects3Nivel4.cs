...
public class DestinationDestino1Objects3Nivel4 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa1Objects3Nivel4 draggableObject = other.GetComponent<DraggablePecaCaixa1Objects3Nivel4>();
