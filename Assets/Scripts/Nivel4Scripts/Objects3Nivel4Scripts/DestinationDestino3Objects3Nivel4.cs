...
public class DestinationDestino3Objects3Nivel4 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa3Objects3Nivel4 draggableObject = other.GetComponent<DraggablePecaCaixa3Objects3Nivel4>();
