...
public class GameManagerObjects3Nivel4 : MonoBehaviour
{
    ...
    public ARPlacementAndPlaneDetectionObjects3Nivel4 ARPlacementAndPlaneDetection;
    ...
    private int CountObjects()
    {
        ...
        foreach (string tag in tagsObjectsHaveMove)
        {
            ...
            {
                // Verifique se o objeto implementa a interface IDraggableObjects3Nivel4
                IDraggableObjects3Nivel4 draggableObject = obj.GetComponent<IDraggableObjects3Nivel4>();
