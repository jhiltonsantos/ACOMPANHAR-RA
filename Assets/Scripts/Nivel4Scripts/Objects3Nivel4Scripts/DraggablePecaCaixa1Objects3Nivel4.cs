...
public class DraggablePecaCaixa1Objects3Nivel4 : MonoBehaviour, IDraggableObjects3Nivel4
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationDestino1Objects3Nivel4 destinoScript;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        destinoScript = GetComponentInParent<DestinationDestino1Objects3Nivel4>();
    }
