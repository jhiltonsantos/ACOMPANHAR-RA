...
public class DestinationDestino2Objects3Nivel4 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            DraggablePecaCaixa2Objects3Nivel4 draggableObject = other.GetComponent<DraggablePecaCaixa2Objects3Nivel4>();
