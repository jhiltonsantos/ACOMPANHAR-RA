...
public class DraggablePecaCaixa3Objects5Nivel4 : MonoBehaviour, IDraggableObjects5Nivel4
{
    private ARRaycastManager raycastManager;
    private List<ARRaycastHit> hits = new List<ARRaycastHit>();
    public bool isBeingDragged;
    private Rigidbody rb;
    private DestinationDestino3Objects5Nivel4 destinoScript;

    void Start()
    {
        raycastManager = FindObjectOfType<ARRaycastManager>();
        rb = GetComponent<Rigidbody>();
        destinoScript = GetComponentInParent<DestinationDestino3Objects5Nivel4>();
    }
