...
public class GameManagerObjects5Nivel4 : MonoBehaviour
{
    ...
    public ARPlacementAndPlaneDetectionObjects5Nivel4 ARPlacementAndPlaneDetection;
    ...
    private int CountObjects()
    {
        ...
        foreach (string tag in tagsObjectsHaveMove)
        {
            ...
            {
                // Verifique se o objeto implementa a interface IDraggableObjects5Nivel4
                IDraggableObjects5Nivel4 draggableObject = obj.GetComponent<IDraggableObjects5Nivel4>();
