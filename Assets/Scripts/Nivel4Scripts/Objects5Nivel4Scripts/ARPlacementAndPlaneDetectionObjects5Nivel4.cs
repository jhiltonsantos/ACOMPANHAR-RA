...
public class ARPlacementAndPlaneDetectionObjects5Nivel4 : MonoBehaviour
{
    ARSessionOrigin m_ARSessionOrigin;
    ARPlaneManager m_ARPlaneManager;
    ARPlacementManagerObjects5Nivel4 m_ARPlacementManager;
    ...
    private void Awake()
    {
        ...
        m_ARPlacementManager = m_ARSessionOrigin.GetComponent<ARPlacementManagerObjects5Nivel4>();
    }
