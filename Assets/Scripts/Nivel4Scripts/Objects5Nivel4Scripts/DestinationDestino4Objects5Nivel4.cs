...
public class DestinationDestino4Objects5Nivel4 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.CompareTag("PecaCaixa4"))
        {
            DraggablePecaCaixa4Objects5Nivel4 draggableObject = other.GetComponent<DraggablePecaCaixa4Objects5Nivel4>();
